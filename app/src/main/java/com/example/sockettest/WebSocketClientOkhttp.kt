...
class WebSocketClientOkhttp {
    ...
    companion object {
        private lateinit var instance: WebSocketClientOkhttp

        @JvmStatic
        @Synchronized
        //This function gives singleton instance of WebSocket.
        fun getInstance(): WebSocketClientOkhttp {
            synchronized(WebSocketClientOkhttp::class) {
                if (!::instance.isInitialized) {
                    instance = WebSocketClientOkhttp()
                }
            }
            return instance
        }
